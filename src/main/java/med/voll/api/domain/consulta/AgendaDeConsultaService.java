...
import med.voll.api.domain.consulta.desafio.ValidadorDeCancelacionDeConsulta;
...
public class AgendaDeConsultaService {
    ...
    @Autowired
    private List<ValidadorDeCancelacionDeConsulta> validadorCancelacion;
    ...
    public void cancelar(DatosCancelacionConsulta datos) {
        ...
        validadorCancelacion.forEach(v -> v.validarCancelacion(datos));
